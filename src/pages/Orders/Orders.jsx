        ...
        <div key={singleOrder._id} className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
          <div className="flex justify-start item-start space-y-2 flex-col">
            ...
            <p className="text-base dark:text-gray-300 font-medium leading-6 text-gray-600">
              {new Date(singleOrder.createdAt).toLocaleDateString()} at{' '}
                  ...
                  <div key={cartItem._id} className="mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                    ...
                    <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full pb-8 space-y-4 md:space-y-0">
                      <div className="w-full flex flex-col justify-start items-start space-y-8">
                        <h3 className="text-xl xl:text-2xl font-semibold leading-6 text-gray-800">{cartItem.product.title}</h3>
                      </div>
                      <div className="flex justify-between space-x-8 items-start w-full">
                        <div>
                          <p className="text-base font-bold mb-2 xl:text-lg leading-6">Unit Price</p>
                          <p className="text-base text-center xl:text-lg leading-6">{cartItem.price}</p>
                        </div>
                        <div>
                          <p className="text-base font-bold mb-2 xl:text-lg leading-6">Quantity</p>
                          <p className="text-base text-center xl:text-lg leading-6 text-sky-800">{cartItem.count}</p>
                        </div>
                        <div>
                          <p className="text-base font-bold mb-2 xl:text-lg leading-6">Total Price</p>
