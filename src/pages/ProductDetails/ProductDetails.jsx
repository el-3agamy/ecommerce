...
//   const { id } = useParams();
//   const { data: details, isLoading } = useFetchData(`products/${id}`);
...
//             <img src={details?.imageCover} alt="Product" className="w-full h-auto rounded-lg shadow-md mb-4" />
//             {details?.images.map((sliderImg, i) => (
//               <div key={i}>
//                 <img src={sliderImg} alt="product_image" />
//               </div>
//             ))}
//           </Slider>
//         </div>
...
//           <div className="mb-4">
//             <PriceDisplay price={details?.price} priceAfterDiscount={details?.priceAfterDiscount} large />
//           </div>
//           <div className="flex items-center mb-4">
//             <StarRating rating={details?.ratingsAverage} showValue={false} />
...
//             <span className="font-mono">{details?.category?.name}</span>
//           </h5>
//           <h5>
//             <span className="font-bold">Brand: </span>
//             <span className="font-mono">{details?.brand?.name}</span>
//           </h5>
...
//               onPress={() => addToCart('cart', details?._id, setAddLoading)}
...
//               onPress={() => addToCart('wishlist', details?._id, setWishlistLoading)}
